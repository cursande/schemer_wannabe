...
;; Define a constructor make-segment and selectors start-segment and end-segment that define the representation
...
(define start-point (cons 3 4))
(define end-point (cons 7 8))

(print-point (midpoint-segment start-point end-point)) ; => (5,6)
