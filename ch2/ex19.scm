...
;; change a British pound, for example.

;; As the program is written, the knowledge of the currency is distributed partly into the procedure
;; first-denomination and partly into the procedure count-change (which knows that there are five kinds of U.S. coins).
...
(define us-coins-jumbled (list 25 10 1 5 50))
(define uk-coins-jumbled (list 1 0.5 2 10 5 20 100 50))

(cc 100 us-coins-jumbled) ; => 292
(cc 20 uk-coins-jumbled) ; => 293

;; The order doesn't matter because we process all possible combinations anyway.
;; Whether we do bigger or smaller numbers first doesn't affect how many ways we
;; can subtract coins to make 100, 20, or whatever.
