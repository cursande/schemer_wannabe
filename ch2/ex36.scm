...
;; the second elements of the sequences, and so on, and returns a sequence of the results.
...
[[1 2 3]
 [4 5 6]] ;; => [(op 1 4) (op 2 5) (op 3 6)]

(define s1 (list (list 1 2 3) (list 4 5 6)))

(accumulate-n + 0 s1) ; => '(5 7 9)

(define s2 (list (list 1 2 3) (list 4 5 6) (list 7 8 9) (list 10 11 12)))

(accumulate-n + 0 s2) ; => '(22 26 30)
